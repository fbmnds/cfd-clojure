...
;; '(+ (* -4. t) x)**2' to '(m/pow (+ (* -4. t) x) 2.)'

;; -2*nu*(-1.*(-8*t + 2*x)*exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))/(* 4. nu (inc t)) - (* 2. (+ (* -4 t) x -6.28318530717959))*exp(-1.*(+ (* -4 t) x -6.28318530717959)**2/(* 4. nu (inc t)))/(* 4. nu (inc t)))/(exp(-1.*(+ (* -4 t) x -6.28318530717959)**2/(* 4. nu (inc t))) + exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))) + 4

;; '(+ (* -4 t) x -6.28318530717959)**2' '(m/pow (+ (* -4 t) x -6.28318530717959) 2.)'

;; -2*nu*(-1.*(-8*t + 2*x)*exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))/(* 4. nu (inc t)) - (* 2. (+ (* -4 t) x -6.28318530717959))*exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/(* 4. nu (inc t)))/(* 4. nu (inc t)))/(exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/(* 4. nu (inc t))) + exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))) + 4
...
;; extract 'exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))'
(comment
(let [f1 exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))]
-2*nu*(-1.*(+ (* -8. t) (* 2. x))*f1/(* 4. nu (inc t)) - (* 2. (+ (* -4 t) x -6.28318530717959))*exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/(* 4. nu (inc t)))/(* 4. nu (inc t)))/(exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/(* 4. nu (inc t))) + f1) + 4
))
...
(let [f1 exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))
      f2 (* 4. nu (inc t))]
-2*nu*(-1.*(+ (* -8. t) (* 2. x))*f1/f2 - (* 2. (+ (* -4 t) x -6.28318530717959))*exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/f2)/f2)/(exp(-1.*(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/f2) + f1) + 4
))


;; extract '(m/pow (+ (* -4 t) x -6.28318530717959) 2.)/f2)'
(comment
(let [f1 exp(-1.*(m/pow (+ (* -4. t) x) 2.)/(* 4. nu (inc t)))
      f2 (* 4. nu (inc t))
      f3 (m/pow (+ (* -4 t) x -6.28318530717959) 2.)]
